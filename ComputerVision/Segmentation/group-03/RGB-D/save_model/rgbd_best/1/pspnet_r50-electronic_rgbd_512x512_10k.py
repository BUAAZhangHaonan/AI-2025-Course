...
launcher = 'none'
load_from = 'work_dirs/electronic_component_rgbd_pspnet/best_mIoU_iter_10000.pth'
log_level = 'INFO'
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        pipeline=[
            ...
            dict(normalize=True, to_float32=True, type='LoadDepthFromFile'),
...
visualizer = dict(
    name='visualizer',
    save_dir='results/rgbd_visualization',
