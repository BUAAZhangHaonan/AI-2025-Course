custom_imports = dict(
    ...
    imports=[
        'new_projects.deepcrack.mmseg.datasets.deepcrack',
        'new_projects.deepcrack.mmseg.datasets.transforms.deepcrack_transforms',
    ])
...
work_dir = 'work_dirs/deepcrack_pspnet_optimized_v2'
